...
class Rsk3 extends AbstractWeb3Module {
  constructor(provider, methodFactory, net, accounts, personal, abiCoder, utils, formatters, subscriptionsFactory, contractModuleFactory, options, nodeNet) {
...
function Rsk3$1(provider, net = null, options = {}) {
  ...
  return new Rsk3(resolvedProvider, new MethodFactory(Utils, formatters), new Network(resolvedProvider, null, options), accounts, new Personal(resolvedProvider, null, accounts, options), abiCoder, Utils, formatters, new SubscriptionsFactory(Utils, formatters), new ContractModuleFactory(Utils, formatters, abiCoder, accounts), options, net);
}

export { Rsk3$1 as Rsk3, TransactionSigner$1 as TransactionSigner };
