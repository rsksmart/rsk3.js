...
describe('toWei', function () {
  ...
  describe('numberToString', function () {
    it('should handle error cases', function () {
      const tests = [
        ...
        { value: [], expected: Error },
        { value: '-1sdffsdsdf', expected: 'while converting number to string, invalid number value \'-1sdffsdsdf\', should be a number matching (^-?[0-9.]+).' },
        { value: '-0..-...9', expected: 'while converting number to string, invalid number value \'-0..-...9\', should be a number matching (^-?[0-9.]+).' },
  ...
  describe('getValueOfUnit', function () {
    it('should handle error cases', function () {
      const tests = [
        { value: 'something', expected: Error },
        { value: 'wrongunit', expected: Error },
      ]
      tests.forEach(test => {
